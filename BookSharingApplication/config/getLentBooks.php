...
if($conn==false){
    ...
    $email=$data['email'];
    $stmt=$conn->query("select b.id, t.borrower_email, b.title, b.author, b.genre, b.start_Date_Time, b.end_Date_Time from TRANSACTION t, book b where t.lender_email = '".$email."'and t.book_Id = b.id;");
    $stmt->execute();
    $format=array();
